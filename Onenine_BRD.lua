...
function user_setup()
    ...
    brd_daggers = S{'Taming Sari', 'Kali'}
    pick_tp_weapon()
	...
	gear.intarabus_fc	={ name="Intarabus's Cape", augments={'CHR+20','Mag. Acc+20 /Mag. Dmg.+20','Mag. Acc.+10','"Fast Cast"+10','Phys. dmg. taken-10%',}}

    -- Additional local binds
    send_command('bind ^` gs c cycle ExtraSongsMode')
    send_command('bind !z input /ma "Chocobo Mazurka" <me>')
...
function init_gear_sets()
    ...
    sets.precast.FC.BardSong = set_combine(sets.precast.FC, {
		...
		feet=gear.telchine_feet_pet_dt
	})
